...
public class PipelineController {
    ...
    public Map<String, Object> listPipelines(
        ...
        Page<PipelineRunResponse> p = pipelineService.listPipelines(repoIdOrName, status, page, size);
        return Map.of(
                "items", p.getContent(),
    ...
    public PipelineRunResponse getPipeline(@PathVariable UUID id) {
    ...
    public PipelineRunResponse rerunPipeline(
        ...
        return pipelineService.rerunPipeline(id, userId);
    }
